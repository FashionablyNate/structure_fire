 ...
 class Ball extends Entity {
	...
	public Ball(final float x, final float y, final float vx, final float vy) {
		...
		addImageWithBoundingBox(ResourceManager
				.getImage(StructureFireGame.BALL_BALLIMG_RSC));
	...
	public void bounce(float surfaceTangent) {
		removeImage(ResourceManager.getImage(StructureFireGame.BALL_BALLIMG_RSC));
		addImageWithBoundingBox(ResourceManager
				.getImage(StructureFireGame.BALL_BROKENIMG_RSC));
		countdown = 500;
